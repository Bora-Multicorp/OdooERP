...
""",
    ...
    'assets': {
        'ks_dashboard_ninja.ks_dashboard_lib': [
            '/ks_dashboard_ninja/static/lib/gridstack/grid-stack.min.css',
            '/ks_dashboard_ninja/static/lib/gridstack/gridstack-all.js',
        ...
        'web.assets_backend': [
            'web/static/lib/jquery/jquery.js',  # TODO: Remove jquery Lib
            ...
            'ks_dashboard_ninja/static/src/js/dn_utils.js',
            'ks_dashboard_ninja/static/src/js/access_utils.js',
            'ks_dashboard_ninja/static/src/js/gsUtils.js',
            'ks_dashboard_ninja/static/src/js/dn_store.js',
            'ks_dashboard_ninja/static/lib/js/index.js',
            'ks_dashboard_ninja/static/lib/js/pdfmake.js',
            'ks_dashboard_ninja/static/lib/js/percent.js',      #FIXME: Why library files are here , if they are loaded under custom bundle
            'ks_dashboard_ninja/static/lib/js/pdf.min.js',
            'ks_dashboard_ninja/static/lib/js/print.min.js',
            'ks_dashboard_ninja/static/lib/js/Dataviz.js',
            'ks_dashboard_ninja/static/lib/js/Material.js',
            ...
            'ks_dashboard_ninja/static/src/js/chart_utils.js',
            ...
            'ks_dashboard_ninja/static/src/js/skeletons/*',
            'ks_dashboard_ninja/static/src/odoo_base_extend/**/*',
            ("remove", "ks_dashboard_ninja/static/src/**/*.dark.scss"),
        ],
        'web.assets_web_dark': [
                'ks_dashboard_ninja/static/src/**/*.dark.scss',
            ],
    },
