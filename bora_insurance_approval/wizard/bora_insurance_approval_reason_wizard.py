...
class BoraInsuranceApprovalReasonWizard(models.TransientModel):
    _name = 'bora.insurance.approval.reason.wizard'
    _description = 'Bora Insurance Approval / Rejection Reason Wizard'

    bora_policy_id = fields.Many2one('insurance.policy', string='Insurance Policy', required=True)
    ...
    def action_submit(self):
        ...
        if self.bora_action_type == 'reject':
            self.bora_policy_id.bora_do_reject_insurance(reason)
