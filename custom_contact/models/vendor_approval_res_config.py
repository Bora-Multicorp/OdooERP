...
class VendorApprovalConfig(models.Model):
    ...
    def unlink(self):
        ...
        affected_pos = self.env['res.partner.kyc.approval']  # empty recordset
        ...
        for approver in self:
            ...
            affected_pos |= kycs  # accumulate affected POs
        ...
        for kyc in affected_pos:
            po_users = kyc.approval_users_ids.sorted(key='sequence')
