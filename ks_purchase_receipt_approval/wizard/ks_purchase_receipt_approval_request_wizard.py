...
class KsPurchaseReceiptApprovalRequestWizard(models.TransientModel):
    ...
    def action_confirm_request(self):
        ...
        if is_update:
            self.ks_picking_id._ks_cancel_receipt_activities()
            ...
            pre_state = self.ks_picking_id.ks_receipt_pre_approval_state or 'assigned'
            self.ks_picking_id.write({'state': pre_state})

        self.ks_picking_id.ks_do_request_receipt_approval(
