...
class KsDeliveryApprovalReasonWizard(models.TransientModel):
    _name = 'ks.delivery.approval.reason.wizard'
    _description = 'KS Delivery Approval / Rejection Reason Wizard'
    ...
    ks_reason = fields.Text(string='Reason', required=True,
    ...
    def action_submit(self):
        ...
        if self.ks_action_type == 'approve':
            self.ks_picking_id._ks_do_approve_delivery_with_reason(reason, self.env.user)
        else:
            self.ks_picking_id.ks_do_reject_delivery(reason)
