# -*- coding: utf-8 -*-
{
    ...
    'depends': ['l10n_in','base', 'contacts', 'account', 'accountant', 'purchase', 'sale', 'sale_management', 'survey', 'case_sensitive_widget', 'sh_survey_matrix_adv','base_multi_company', 'ks_contact_access_rights','ks_sale_order'],
    # always loaded
    'data': [
        ...
        'wizard/partner_approval_user_picker_wizard.xml',
        'wizard/partner_approve_request_views.xml',
        'wizard/partner_reject_request_views.xml',
