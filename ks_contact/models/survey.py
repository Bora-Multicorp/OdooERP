...
class InheritSurvey(models.Model):
    ...
    survey_image = fields.Image("Survey Image", tracking=True)
    vendor_reg_url = fields.Char("Vendor Registration URL", tracking=True)
...
class InheritSurveyQuestion(models.Model):
    ...
    is_pan = fields.Boolean("Is PAN", tracking=True)
